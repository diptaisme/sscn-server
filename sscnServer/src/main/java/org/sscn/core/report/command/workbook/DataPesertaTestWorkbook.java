...
public class DataPesertaTestWorkbook extends BaseWorkbook {

	/** The Constant LOG. */
	private static final Log LOG = LogFactory
			.getLog(DataPesertaTestWorkbook.class);
	 ...
	 */
	public DataPesertaTestWorkbook(Map<String, Object> sheetProperties) {
	...
	private void setTheProperties(Map<String, Object> sheetProperties) {
		reportType = GeneralReportUtil.RPT_DATA_PESERTA_TEST;
		formatData = getStringParameter(sheetProperties,
				ReportDataPesertaTestCommand.FORMAT);
		instansi = getStringParameter(sheetProperties,
				ReportDataPesertaTestCommand.INSTANSI);
		waktu = getStringParameter(sheetProperties,
				ReportDataPesertaTestCommand.WAKTU);
	}
}
