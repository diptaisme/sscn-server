...
import org.sscn.dao.UserPesertaDao;
...
import org.sscn.persistence.entities.UserPeserta;
...
@Repository("UserPesertaDao")
public class UserPesertaDaoImpl extends CoreDaoImpl<UserPeserta> implements
		UserPesertaDao {
	/**
	 * Default constructor.
	 * 
	 ...
	 */
	@Autowired
	public UserPesertaDaoImpl(SessionFactory sessionFactory) {
		super(UserPeserta.class, sessionFactory);
	}
}
