...
<link href="/sscnServer/resources/css/ui-lightness/jquery-ui-1.8.21.custom.css"
	rel="stylesheet">
...
<link href="/sscnServer/resources/css/pages/dashboard.css" rel="stylesheet">
...
<script src="/sscnServer/resources/js/plugins/flot/jquery.flot.orderBars.js"></script>
<script src="/sscnServer/resources/js/plugins/flot/jquery.flot.pie.js"></script>
<script src="/sscnServer/resources/js/plugins/flot/jquery.flot.resize.js"></script>
						...
						<div class="widget-content">
							...
							<div class="shortcuts">
								<a href="javascript:;" class="shortcut"> <i
									...
									class="shortcut"> <i class="shortcut-icon icon-bookmark"></i>
									<span class="shortcut-label">Bookmarks</span> </a> <a
									...
									class="shortcut"> <i class="shortcut-icon icon-comment"></i>
									<span class="shortcut-label">Comments</span> </a> <a
									href="javascript:;" class="shortcut"> <i
									...
									class="shortcut-label">Notes</span> </a>
							...
							<div class="pull-left">
								...
								<div class="btn-group">
									<a class="btn btn-small dropdown-toggle" data-toggle="dropdown"
										href="#"> Admin Themes <span class="caret"></span> </a>
									<ul class="dropdown-menu">
						...
						<div class="widget-header">
							...
							<div class="widget-actions">
								<a href="javascript:;" class="btn btn-small btn-primary"> <i
									class="icon-plus"></i> Start Application </a>
							</div>
							<!-- /.widget-actions -->
						</div>
						<!-- /.widget-header -->
