							...
							<div id="example_wrapper" class="dataTables_wrapper form-inline"
								...
								<div>									
									<div>
										...
										&nbsp;&nbsp;Under Construction-->
											<BR/>											
											<form method="POST" name="formDownloadDataPendaftaran" action="ReportServlet" target="_BLANK">
											...
											<BR/>
											<form method="POST" name="formDownloadDataPesertaTest" action="ReportServlet" target="_BLANK">
											...
											<BR/>
											<form method="POST" name="formDownloadDataRekapanPendaftaran" action="ReportServlet" target="_BLANK">
