...
<body>
	...
	<div id="myModal" title="Check">
		<form class="form-horizontal" action="verifikasiSave.do"
			...
			<fieldset>
				...
				<div class="control-group">
					<div class="controls">
						<input type="checkbox" id="selectedAll">Select/Unselect All 
					</div>
				</div>
	...
	<form action="/ReportServlet" method="post" id="cetak" target="_blank">
				...
				.ready(
						function() {
							...
							$("#selectedAll").click( function(){
 								...
 								$('input[name=persyaratanIds\\[\\]]').attr("checked", checkedValue); 								
 							});
