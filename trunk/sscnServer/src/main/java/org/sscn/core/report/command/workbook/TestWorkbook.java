...
public class TestWorkbook extends BaseWorkbook {
	...
	private void setTheProperties(Map<String, Object> sheetProperties) {
		reportType = GeneralReportUtil.RPT_TEST_CETAK_XLS;
		formatData = getStringParameter(sheetProperties,
				RptTestXlsCommand.FORMAT);
		param1 = getStringParameter(sheetProperties, RptTestXlsCommand.PARAM_1);
		param2 = getStringParameter(sheetProperties, RptTestXlsCommand.PARAM_2);
	}
}
