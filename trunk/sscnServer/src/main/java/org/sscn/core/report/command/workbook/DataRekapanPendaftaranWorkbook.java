...
public class DataRekapanPendaftaranWorkbook extends BaseWorkbook {
	...
	private static final Log LOG = LogFactory
			.getLog(DataRekapanPendaftaranWorkbook.class);
	 ...
	 */
	public DataRekapanPendaftaranWorkbook(Map<String, Object> sheetProperties) {
	...
	private void setTheProperties(Map<String, Object> sheetProperties) {
		reportType = GeneralReportUtil.RPT_REKAPAN_PENDAFTARAN;
		formatData = getStringParameter(sheetProperties,
				ReportRekapanPendaftaranCommand.FORMAT);
		instansi = getStringParameter(sheetProperties,
				ReportRekapanPendaftaranCommand.INSTANSI);
		waktu = getStringParameter(sheetProperties,
				ReportRekapanPendaftaranCommand.WAKTU);
	}
}
